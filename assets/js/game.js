...
for (var i = 0; i < enemyNames.length; i++) {
  ...
  if (playerHealth > 0) {
    ...
    // math floor makes whole number from math random plus always add 40 max around 60
...
function shop() {
  ...
  switch (shopOptionPrompt) {
    ...
    case "REFILL":
      ...
      window.alert("Refilling player health by 20 for 7 money.");
       ...
       case "UPGRADE":
         ...
         case "LEAVE":
           ...
           default:
             ...
             // call shop() forces player to pick valid option
             shop();
             break;
  }
